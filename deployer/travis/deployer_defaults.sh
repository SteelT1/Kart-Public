...
: ${ASSET_ARCHIVE_PATH:=https://lightdash.org/kart/assets/srb2kart-v103-assets.7z}
: ${ASSET_ARCHIVE_OPTIONAL_PATH:=https://lightdash.org/kart/assets/srb2kart-v103-optional-assets.7z}
